...
Start-Sleep 30
    ...
    try {
        ...
        $params = @{
            ...
            siteId    = "{5ef08fa0-8791-45ae-8eaa-f6d58a6f9629}"
            webId     = "{2f3f7ddc-4830-45c3-bf2f-d2da4f8310ad}"
            listId    = "{b1067f03-96e6-4030-92bb-6bb7d34cb352}"
            userEmail = $userUpn
            webUrl    = "https://cfcrights.sharepoint.com/sites/Shared"
            webTitle  = "Shared"
            listTitle = "Documents"
        }
