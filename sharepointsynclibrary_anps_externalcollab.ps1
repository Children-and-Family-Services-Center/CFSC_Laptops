...
# Find + Replace variables in the "params" section
    ...
    try {
        ...
        $params = @{
            ...
            siteId    = "{0393cbea-fd1c-4bb4-aafa-6f0f43ee3bd2}"
            webId     = "{d25c54a2-dfc3-4b08-9a32-1b1757c1f36e}"
            listId    = "{bf9f88bc-9436-42c0-a608-20f955843005}"
            userEmail = $userUpn
            webUrl    = "https://childrenfamily.sharepoint.com/sites/ExternalCollaboration"
