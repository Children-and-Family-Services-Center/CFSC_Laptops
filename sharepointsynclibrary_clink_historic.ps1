...
# Find + Replace variables in the "params" section
    ...
    try {
        ...
        $params = @{
            ...
            siteId    = "{dd12032e-6bae-486b-b8c8-a8309b04a25f}"
            webId     = "{6adb4612-06ad-44a3-ab8c-355de191bea9}"
            listId    = "{dfebaba3-b6cb-4521-83d3-eed98987b88f}"
            userEmail = $userUpn
            webUrl    = "https://communitylinknc.sharepoint.com/sites/Historic"
            webTitle  = "Historic"
            listTitle = "Documents"
        }
