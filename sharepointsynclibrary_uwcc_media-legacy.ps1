...
try {
    ...
    $params = @{
        ...
        siteId    = "{3be59955-62b3-429a-8cc3-91675be55148}"
        webId     = "{443bfcaa-13b3-4362-8e67-8f2a0fa02a6f}"
        listId    = "{016300a8-44b8-4642-a232-eee3c5feb020}"
        userEmail = $userUpn
        webUrl    = "https://unitedwaycc.sharepoint.com/sites/Media"
        webTitle  = "Media"
        listTitle = "Documents"
    }
