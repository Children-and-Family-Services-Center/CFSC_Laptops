...
Start-Sleep 30
    ...
    try {
        ...
        $params = @{
            ...
            siteId    = "{0f003d0e-5915-4381-b25a-69571dda0f94}"
            webId     = "{080a5149-2568-49a3-8f72-ac8a6e146338}"
            listId    = "{5de53e69-3e52-4469-be94-1e03c2586026}"
            userEmail = $userUpn
            webUrl    = "https://carolinarainorg.sharepoint.com/sites/Shared"
            webTitle  = "Shared"
            listTitle = "Documents"
        }
