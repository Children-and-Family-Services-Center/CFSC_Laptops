...
# Find + Replace variables in the "params" section
    ...
    try {
        ...
        $params = @{
            ...
            siteId    = "{9385cbd7-6b19-4bba-b2f1-83ada24049c4}"
            webId     = "{5e3d318c-9cfe-4308-8db1-ff64c667f254}"
            listId    = "{49cd3ea5-8ed2-45cf-bd21-28314c6232ba}"
            userEmail = $userUpn
            webUrl    = "https://medassistnc.sharepoint.com/sites/Shared"
            webTitle  = "Shared"
            listTitle = "Documents"
        }
