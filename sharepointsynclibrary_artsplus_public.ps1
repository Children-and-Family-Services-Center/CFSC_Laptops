...
# Wait another 45 to delay behind the other Sharepoint logon script
Start-Sleep 45
    ...
    try {
        ...
        $params = @{
            ...
            siteId    = "{3f0a4a1b-f315-4677-89ff-6abed9e1a7b6}"
            webId     = "{8dd4db4b-79dd-4a81-88a4-e36757e49805}"
            listId    = "{60cb5abb-3948-4b11-98af-821db2b882d7}"
            userEmail = $userUpn
            webUrl    = "https://artsplusorg.sharepoint.com/sites/Public"
            webTitle  = "Public"
            listTitle = "Documents"
        }
